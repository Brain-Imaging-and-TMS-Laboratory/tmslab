...
2. **Build test:**
   ...
   # Publications should render at http://localhost:4000/tmslab/publications/
   ```
...
- Check the publications page at http://localhost:4000/tmslab/publications to verify display
